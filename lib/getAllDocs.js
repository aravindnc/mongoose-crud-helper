const MongoosePaginate = require('mongoose-custom-pagination');
...
function getAllDocs(schema, options) {
    ...
    schema.statics.getAllDocs = function(whereCond, userOptions) {
        ...
        const lean = (userOptions.lean === true) ? true : false;
        const leanWithId = (userOptions.leanWithId === true) ? true : false;
